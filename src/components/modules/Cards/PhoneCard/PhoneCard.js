    ...
    <div
      ...
      className={
        ...
        (props.reverse !== undefined
          ? "overview-item--reverse animated-left"
          : "animated-right")
      }
    >
      <div className="overview-item__presentation">
        <div className="overview-item__phone">
          ...
          <img
            src={props.overlay}
            alt="overlay"
            className="overview-item__overlay"
          />
          <div
            className={
              "overview-item__background " +
              (props.reverse !== undefined
                ? "overview-item__background--blue"
                : "overview-item__background--pink")
            }
          >
            &nbsp;
          </div>
      ...
      <div className="overview-item__content">
        <h3
          className={
            ...
            (props.reverse !== undefined ? "u-left-text" : "u-right-text")
          }
        >
          {props.title}
        </h3>
